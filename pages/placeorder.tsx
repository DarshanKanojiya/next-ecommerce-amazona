...
import { CartItemProps, CustomPageProps } from "../types";

const PlaceOrderScreen: NextPage & CustomPageProps = () => {
  const { state, dispatch } = useContext(Store);
  const [stripePopup, setStripedPopup] = useState<boolean>(false);
  const { cart } = state;
